...
INSERT INTO test_case (target_name, high_res, anti_aliasing, screenshot, graphics_settings_anisotropic, graphics_settings_double_sampling, graphics_settings_post_screen_effects, water_effects_id, particle_system_quality_id)
               VALUES ('Target 1',  false,    0,             false,      true,                          false,                             false,                                 1,                1);
INSERT INTO test_case (target_name, high_res, anti_aliasing, screenshot, graphics_settings_anisotropic, graphics_settings_double_sampling, graphics_settings_post_screen_effects, water_effects_id, particle_system_quality_id)
               VALUES ('Target 2',  true,     2,             false,      true,                          true,                              true,                                  2,                2);
