...
-- Show all test cases
SELECT
test_case.target_name, test_case.high_res, test_case.anti_aliasing, test_case.graphics_settings_anisotropic, test_case.graphics_settings_double_sampling, test_case.graphics_settings_post_screen_effects,
